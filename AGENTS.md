...
- Before PR: new branch from `main`, tests for new code, `npm test` passes, docs updated, no commented-out code/console.log, match code style (named exports, no semicolons, vitest).
